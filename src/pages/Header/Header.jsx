        ...
        <div className="p-[2px] md:rounded-full bg-gradient-to-r from-emerald-400 via-cyan-500 to-indigo-500 animate-gradient-x">
          <nav className="bg-gray-900/90 backdrop-blur-md md:rounded-full px-4 md:px-6 py-2.5">
            ...
            <div className="flex justify-between items-center md:hidden px-2">
              {/* Logo that turns into name on hover */}
              <Link to="/" className="flex items-center text-white font-bold group">
                {/* React Logo (default) */}
                <FaReact
                  className="w-8 h-8 text-cyan-400 animate-spin-slow 
                             group-hover:hidden transition duration-300"
                />
                {/* Text (shows on hover) */}
                <span
                  className="hidden group-hover:inline transition duration-300 text-sm ml-1"
                >
                  Sibaram Pradhan
                </span>
              </Link>
